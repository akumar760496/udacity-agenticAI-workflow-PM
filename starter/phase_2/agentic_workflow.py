...
with open(product_spec_path, encoding="utf-8") as product_spec_file:
...
routing_agent.agents = [
    ...
    },
    {
        ...
        "description": "Responsible for defining product features by grouping related user stories",
        "func": lambda query: program_manager_support_function(query),
    },
    {
        "name": "Development Engineer",
        "description": "Responsible for defining engineering tasks required to implement user stories",
...
# ****
workflow_prompt = (
    "Create a complete development plan for this product including user stories, "
...
for step in workflow_steps:
    ...
    selected_agent = routing_agent.last_selected_agent
    if selected_agent is not None:
        section_by_agent = {
            "Product Manager": "Product Manager - User Stories",
            "Program Manager": "Program Manager - Product Features",
            "Development Engineer": "Development Engineer - Engineering Tasks",
        }
        section = section_by_agent.get(selected_agent["name"])
        if section is not None:
            project_plan[section].append(result)
    print(f"Result: {result}")

print("\nFinal consolidated project plan:")
for section, results in project_plan.items():
    print(f"\n## {section}")
    if results:
        for result in results:
            print(result)
    else:
        print("No result was generated for this section.")